...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-home': { kind: 'none', reason: 'Browser-side triage view over the session list; registers nothing model-facing.' },
  ...
  'packages/session/session-last-turn-outcome': { kind: 'none', reason: 'The lastTurnOutcome unit folds already-logged turn/end reasons into a client-facing read model and registers nothing model-facing.' },
